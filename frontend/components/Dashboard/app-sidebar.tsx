        ...
        navMain: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { title: "Movimentações", url: "/dashboard/stocks/movements" },
                ],
            },
            {
                title: "Relatórios",
                url: "#",
                items: [
                    { title: "Resumo de Estoque", url: "/reports/stock" },
                    { title: "Movimentações", url: "/reports/movements" },
                ],
            },
            {
                title: "Cadastros",
